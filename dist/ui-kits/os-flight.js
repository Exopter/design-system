...
(() => {
  ...
  (function() {
    const P = {
      flysight: '<g fill="currentColor" stroke="none" transform="translate(2 2) scale(.1041667)"><path fill-rule="evenodd" d="M46 44C57 41 68 45 78 52C70 50 62 51 55 54C79 83 87 119 76 153C84 162 91 164 96 164V169C88 169 80 165 74 160C72 169 75 177 79 183C72 181 67 176 64 172L69 157C35 147 10 124 0 102C8 78 26 57 46 44ZM43 59C61 78 79 117 70 152C43 143 19 123 12 105C18 88 30 70 43 59Z"/><path fill-rule="evenodd" transform="translate(192 0) scale(-1 1)" d="M46 44C57 41 68 45 78 52C70 50 62 51 55 54C79 83 87 119 76 153C84 162 91 164 96 164V169C88 169 80 165 74 160C72 169 75 177 79 183C72 181 67 176 64 172L69 157C35 147 10 124 0 102C8 78 26 57 46 44ZM43 59C61 78 79 117 70 152C43 143 19 123 12 105C18 88 30 70 43 59Z"/><path d="M50 7C71 18 87 40 96 61C105 40 121 18 142 7C122 25 110 44 104 65L96 72L88 65C82 44 70 25 50 7Z"/></g>',
      exopter: '<g fill="currentColor" stroke="none"><rect x="3.154" y="2" width="17.692" height="4.615" rx="0.385"/><rect x="3.154" y="9.692" width="14.615" height="4.615" rx="0.385"/><rect x="3.154" y="17.385" width="17.692" height="4.615" rx="0.385"/></g>',
  ...
  (function() {
    ...
    function Rail({ room, onRoom }) {
      ...
      } }, /* @__PURE__ */ React.createElement("a", { className: "shell-home-link", href: "../../index.html", title: "Design system", "aria-label": "Exopter", style: { marginBottom: 10, display: "flex", color: "inherit", borderRadius: 8 } }, /* @__PURE__ */ React.createElement("img", { src: "../../assets/logo-shell.svg", width: 30, height: 30, alt: "" })), ROOMS.map((r) => {
  ...
  `;
    ...
    function Logbook2({ flights, onFlightsChange, onOpen, onOpenSignal }) {
      ...
      } }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("strong", { className: "flights-code" }, f.id)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("strong", { style: { fontFamily: "var(--font-data)" } }, f.aircraft)), /* @__PURE__ */ React.createElement("td", null, f.location), /* @__PURE__ */ React.createElement("td", { style: { fontFamily: "var(--font-data)", color: "var(--text-muted)" } }, f.date), /* @__PURE__ */ React.createElement("td", { style: { fontFamily: "var(--font-data)" } }, f.duration), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("span", { className: "flights-source" }, /* @__PURE__ */ React.createElement(Icon, { name: f.source === "FlySight" ? "flysight" : f.source === "ExoFDR" ? "exopter" : f.source === "Live session" ? "radio" : "clock", size: 14 }), f.source)), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement(StatusDot, { state: f.state, label: f.label })), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right", color: "var(--text-muted)" } }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron-right", size: 16 }))))))), drawer && /* @__PURE__ */ React.createElement(FlightDrawer, { mode: drawer, flight: target, flights, onClose: () => setDrawer(null), onCreate: createFlight, onImport: importData, onOpenImport: () => openImport(target), onOpenSignal: () => {
        setDrawer(null);
        onOpenSignal(target);
      } }));
    }
    ...
    function ImportForm({ flight, aircraft, source, onAircraft, onSource }) {
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: EYEBROW }, "Data source"), /* @__PURE__ */ React.createElement("div", { className: "flight-source-grid", style: { marginTop: 9 } }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "flight-source-card", "data-active": source === "ExoFDR", "aria-pressed": source === "ExoFDR", onClick: () => onSource("ExoFDR") }, /* @__PURE__ */ React.createElement(Icon, { name: "exopter", size: 20 }), /* @__PURE__ */ React.createElement("strong", null, "ExoFDR"), /* @__PURE__ */ React.createElement("span", null, "Recorder package copied from the FDR SD card.")), /* @__PURE__ */ React.createElement("button", { type: "button", className: "flight-source-card", "data-active": source === "FlySight", "aria-pressed": source === "FlySight", onClick: () => onSource("FlySight") }, /* @__PURE__ */ React.createElement(Icon, { name: "flysight", size: 20 }), /* @__PURE__ */ React.createElement("strong", null, "FlySight"), /* @__PURE__ */ React.createElement("span", null, "Track files copied from the FlySight removable storage.")))), /* @__PURE__ */ React.createElement("div", { className: "flight-drop" }, /* @__PURE__ */ React.createElement(Icon, { name: "upload", size: 20 }), /* @__PURE__ */ React.createElement("strong", null, source === "ExoFDR" ? "FDR_20260728_1615.zip" : "TRACK.CSV + SENSOR.CSV"), /* @__PURE__ */ React.createElement("span", null, "SD card detected · files ready to import")), flight ? /* @__PURE__ */ React.createElement("div", { className: "flight-detail-card" }, /* @__PURE__ */ React.createElement("span", { style: EYEBROW }, "Attach to prepared flight"), /* @__PURE__ */ React.createElement("div", { className: "flight-detail-grid", style: { marginTop: 11 } }, /* @__PURE__ */ React.createElement(Mini, { label: "Flight", value: flight.id }), /* @__PURE__ */ React.createElement(Mini, { label: "Aircraft", value: flight.aircraft }), /* @__PURE__ */ React.createElement(Mini, { label: "Location", value: flight.location }), /* @__PURE__ */ React.createElement(Mini, { label: "Next status", value: "Processing" }))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flight-detection" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: EYEBROW }, "Aircraft detected"), /* @__PURE__ */ React.createElement("strong", null, "EXO-001 · device EXOFDR-014"))), /* @__PURE__ */ React.createElement("div", { className: "flight-form-grid" }, /* @__PURE__ */ React.createElement(SelectField, { label: "Aircraft", value: aircraft, onChange: onAircraft, options: ["EXO-001", "F-GOCC", "WS-TEST-02", "To complete"] })), /* @__PURE__ */ React.createElement("div", { className: "flight-help" }, "Direct import creates a Flight automatically. Confirm the detected aircraft or select it before processing.")));
    }
